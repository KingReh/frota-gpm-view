...
export const THEMES: ThemeConfig[] = [
  ...
  },
  {
    ...
    tagline: 'Titânio Quente & Rubi Profundo',
    description: 'Acabamento premium de titânio aquecido com profundidade grafite e acentos rubi carmesim de alta voltagem.',
    type: 'dark',
