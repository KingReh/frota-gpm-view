...
import { Info, Building2, Car, Star } from 'lucide-react';
        ...
        <div className="overflow-x-auto scrollbar-hide">
          <table className="w-full caption-bottom text-sm">
            <thead className="[&_tr]:border-b">
              <tr className="border-b border-white/10 hover:bg-transparent bg-white/5">
                <th className="w-[112px] md:w-[144px] text-[10px] uppercase tracking-[0.2em] font-black text-zinc-500 py-6 pl-4 md:pl-8 text-left">Placa</th>
                <th className="text-[10px] uppercase tracking-[0.2em] font-black text-zinc-500 py-6 px-4 md:px-0 text-left">Modelo</th>
                <th className="hidden lg:table-cell text-[10px] uppercase tracking-[0.2em] font-black text-zinc-500 py-6 text-left">Concessionária</th>
                <th className="hidden md:table-cell text-[10px] uppercase tracking-[0.2em] font-black text-zinc-500 py-6 text-left">Tipo</th>
                <th className="hidden sm:table-cell text-[10px] uppercase tracking-[0.2em] font-black text-zinc-500 py-6 text-left">Unidade</th>
                <th className="hidden xl:table-cell text-[10px] uppercase tracking-[0.2em] font-black text-zinc-500 py-6 text-right">Limite Próx. Período</th>
                <th className="text-right text-[10px] uppercase tracking-[0.2em] font-black text-zinc-500 py-6 pr-4 md:pr-8">Saldo</th>
              </tr>
            </thead>
          </table>
                ...
                <tbody>
                  {virtualizer.getVirtualItems().map((virtualRow) => {
                    ...
                    return (
                      ...
                      >
                        <td className="pl-4 md:pl-8 py-3 md:py-4 relative w-[112px] md:w-[144px]">
                            ...
                            <Button
                              ...
                              className={cn(
                                ...
                                preferences.favoritePlates?.includes(vehicle.plate)
                                  ...
                                  : "text-zinc-600 hover:text-yellow-400 hover:bg-white/5 opacity-0 group-hover:opacity-100 focus:opacity-100"
                              )}
                              onClick={(e) => {
                                e.stopPropagation();
                        ...
                        <td className="py-2 md:py-4 px-4 md:px-0">
                        ...
                        <td className="hidden xl:table-cell py-4 text-right font-mono text-[11px] text-zinc-500">
                        ...
                        <td className="text-right py-2 md:py-4 pr-4 md:pr-8">
