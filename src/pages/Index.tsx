    ...
    >
      <div className="space-y-4 sm:space-y-6 md:space-y-8">
        ...
        >
          ...
          <div
            id="fleet-control-bar"
            className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-2 sm:gap-3 md:gap-6 lg:gap-8 glass-panel p-2 sm:p-3 md:p-4 rounded-xl md:rounded-[24px] relative md:sticky md:top-20 z-20 md:z-40 bg-black/60 backdrop-blur-xl border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.4)] transition-all duration-300"
          >
